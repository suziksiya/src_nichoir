...
<body>
    ...
    <div class="header">
        ...
        <p>Ce site internet sert de recueil de données captées par un nichoir. Sur cette page, vous trouverez toutes les informations relatives aux capteurs affichées en temps réel.</p>
        <hr>
        ...
        if ($is_admin) {
            ...
            <h3>Période d\'acquisition des données:</h3>
        ...
        <hr>
        <p><a class='lien' href="logout.php">Se déconnecter</a></p> <!-- lien de déconnexion -->
    </div>

    <!-- Données de température et humidité interieur et exterieur -->
    <div class="container_box">

        <!-- Description température humidité -->
        <div class="tmp_hum_img">
            <h1>Température et humidité</h1>
            <p>Les données suivantes proviennent de deux capteurs DHT22, le premier est situé à l'intérieur du nichoir et le deuxième à l'extérieur. Ces capteurs permettent d'acquérir simultanément la température et l'humidité.</p>
    ...
    <div class="container">
        <h1>Poids</h1>
        <p>Les données suivantes viennent d'un capteur HX711 qui se trouve à l'intérieur du nichoir. Ce capteur récupère la tension en sortie de la cellule de charge, qui sert à la mesure du poids.</p>
        ...
        <canvas id="myChartHX711" style="width: 400px; height: 150px;"></canvas>
    ...
    <!-- Images standard et infrarouges -->
    <div class="container_box">

        <!-- Description des images -->
        <div class="tmp_hum_img">
            <h1>Images</h1>
            <p>Les images suivantes proviennent de deux caméras différentes situées à l'intérieur du nichoir. La première est une caméra standard Raspicam v2.1, qui capture des images à l'aide de lignes de commande. La seconde est une caméra infrarouge AMG8833, équipée d'un capteur de résolution 8x8 pixels, permettant de capturer des images infrarouges.</p>
        </div>

        <!-- Standard -->
        <div class="box">
            <h2>Standards</h2>
            <img src="../img/camera_standard.jpg" style="height:100px;">
            <br>
            <?php
            ...
            if ($resultat_images_stand->num_rows > 0) {
                ...
                while ($row = $resultat_images_stand->fetch_assoc()) {
                    ...
                    echo "<td>" . $date_heure . "</td><td><img src='" . $image_url . "' alt='Image standard'></td></tr>";
                }
                echo "</table>";
            } else {
        ...
        <div class="box">
            <h2>Infrarouges</h2>
            <img src="../img/camera_infrarouge.jpg" style="width:150px; height:100px;">
            <br>
            <?php
            ...
            if ($resultat_images_infra->num_rows > 0) {
                ...
                while ($row = $resultat_images_infra->fetch_assoc()) {
                    ...
                    echo "<td>" . $date_heure . "</td><td><img src='" . $image_url . "' alt='Image infrarouge'></td></tr>";
                }
                echo "</table>";
            } else {
